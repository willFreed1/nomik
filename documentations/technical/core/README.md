...
Shared infrastructure, types, and configuration for all GENOME packages.
...
- Uses `zod` for runtime validation of `genome.config.ts`.
...
- **`GenomeError`**: Base class for all system errors.
